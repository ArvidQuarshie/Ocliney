package com.example.user.ocliney.mUI;
...
import com.example.user.ocliney.DetailActivity;
import com.example.user.ocliney.R;
import com.example.user.ocliney.m_Model.Spacecraft;
